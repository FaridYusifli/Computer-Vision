...
# =============================================================================
#     Creates data generator that can be used for model
# =============================================================================
    ...
    while True:
        names = np.random.permutation(list(archive_train.keys())) #takes random indices
...
def train_model(path_data,path_model,njoints,batch_size=6,optimizer=RMSprop(lr=5e-4),loss='mean_squared_error',metrics=['accuracy'],epochs=200,step_epochs=1000):
# =============================================================================
#     Training the model
# =============================================================================
    global nOutput
